               ...
               <div className="inner-row">
                         <div className="benefits-section-content">
                                    <div className="benefits-intro">
                                            <h2>{language.data.pages.home.benefits.intro.title}</h2>
                                            <p>{language.data.pages.home.benefits.intro.description}</p>
                                    </div>
                                    <div className="benefits-content-row">
                                             <div className="tripple-grid-row">
                                                      ...
                                                      <div className="tripple-grid-item">
                                                                <div className="tripple-grid-column">
                                                                ...
                                                                <div className="tripple-grid-column-short">
                                             ...
                                             <div className="double-grid-row">
                                                       <div className="first-double-column">
                                                       ...
                                                       <div className="second-double-column">
